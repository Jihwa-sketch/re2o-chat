...
// 더 구체적인 카테고리를 먼저 검사한다. "제품 정보"는 "제품"처럼 범용적인
// 단어를 포함해 다른 카테고리 질문에도 흔히 등장하므로 마지막에 검사한다.
const CATEGORY_KEYWORDS_PRIORITY: [Category, string[]][] = [
  [
    "부작용",
    ["결절", "홍반", "알러지", "알레르기", "부작용", "이상반응", "이상 반응", "유해사례"],
  ],
  ["임상 데이터", ["임상", "임상시험", "임상데이터", "리얼월드", "연구결과", "논문"]],
  ["시술 프로토콜", ["프로토콜", "시술법", "시술 방법", "시술순서", "시술 순서", "용법", "사용법"]],
  ["제품 정보", ["제품", "스펙", "사양", "가격", "견적", "성분", "재고", "납기"]],
];
 ...
 * 임상 데이터/부작용처럼 위험도가 높은 카테고리는 더 엄격한 일치율을 요구한다.
 */
